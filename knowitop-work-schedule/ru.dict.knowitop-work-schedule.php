...
Dict::Add('RU RU', 'Russian', 'Русский', array(
	'Class:AttributeCronExpressionHelper:HumanText:empty' => 'каждые',
	'Class:AttributeCronExpressionHelper:HumanText:name_minute' => 'минута',
	'Class:AttributeCronExpressionHelper:HumanText:name_hour' => 'час',
	'Class:AttributeCronExpressionHelper:HumanText:name_day' => 'день',
	'Class:AttributeCronExpressionHelper:HumanText:name_week' => 'неделю',
	'Class:AttributeCronExpressionHelper:HumanText:name_month' => 'месяц',
	'Class:AttributeCronExpressionHelper:HumanText:name_year' => 'год',
	'Class:AttributeCronExpressionHelper:HumanText:text_period' => 'Каждый %s',
	'Class:AttributeCronExpressionHelper:HumanText:text_mins' => ' в %02s минут',
	'Class:AttributeCronExpressionHelper:HumanText:text_time' => ' в %02s:%02s',
	'Class:AttributeCronExpressionHelper:HumanText:text_dow' => ' в %s',
	'Class:AttributeCronExpressionHelper:HumanText:text_month' => ' числа, %s',
	'Class:AttributeCronExpressionHelper:HumanText:text_dom' => ' в %s',
	'Class:AttributeCronExpressionHelper:HumanText:weekdays:monday' => 'понедельник',
	'Class:AttributeCronExpressionHelper:HumanText:weekdays:tuesday' => 'вторник',
	'Class:AttributeCronExpressionHelper:HumanText:weekdays:wednesday' => 'среда',
	'Class:AttributeCronExpressionHelper:HumanText:weekdays:thursday' => 'четверг',
	'Class:AttributeCronExpressionHelper:HumanText:weekdays:friday' => 'пятница',
	'Class:AttributeCronExpressionHelper:HumanText:weekdays:saturday' => 'суббота',
	'Class:AttributeCronExpressionHelper:HumanText:weekdays:sunday' => 'воскресенье',
	'Class:AttributeCronExpressionHelper:HumanText:months:january' => 'январь',
	'Class:AttributeCronExpressionHelper:HumanText:months:february' => 'февраль',
	'Class:AttributeCronExpressionHelper:HumanText:months:march' => 'март',
	'Class:AttributeCronExpressionHelper:HumanText:months:april' => 'апрель',
	'Class:AttributeCronExpressionHelper:HumanText:months:may' => 'май',
	'Class:AttributeCronExpressionHelper:HumanText:months:june' => 'июнь',
	'Class:AttributeCronExpressionHelper:HumanText:months:july' => 'июль',
	'Class:AttributeCronExpressionHelper:HumanText:months:august' => 'август',
	'Class:AttributeCronExpressionHelper:HumanText:months:september' => 'сентябрь',
	'Class:AttributeCronExpressionHelper:HumanText:months:october' => 'октябрь',
	'Class:AttributeCronExpressionHelper:HumanText:months:november' => 'ноябрь',
	'Class:AttributeCronExpressionHelper:HumanText:months:december' => 'декабрь',
));
