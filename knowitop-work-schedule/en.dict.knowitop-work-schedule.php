...
//
// Class: AttributeCronExpressionHelper – a text representation for cron patterns
//

Dict::Add('EN US', 'English', 'English', array(
	'Class:AttributeCronExpressionHelper:HumanText:empty' => '-all-',
	'Class:AttributeCronExpressionHelper:HumanText:name_minute' => 'minute',
	'Class:AttributeCronExpressionHelper:HumanText:name_hour' => 'hour',
	'Class:AttributeCronExpressionHelper:HumanText:name_day' => 'day',
	'Class:AttributeCronExpressionHelper:HumanText:name_week' => 'week',
	'Class:AttributeCronExpressionHelper:HumanText:name_month' => 'month',
	'Class:AttributeCronExpressionHelper:HumanText:name_year' => 'year',
	'Class:AttributeCronExpressionHelper:HumanText:text_period' => 'Every %s',
	'Class:AttributeCronExpressionHelper:HumanText:text_mins' => 'at %02s minutes past the hour',
	'Class:AttributeCronExpressionHelper:HumanText:text_time' => 'at %02s:%02s',
	'Class:AttributeCronExpressionHelper:HumanText:text_dow' => 'on %s',
	'Class:AttributeCronExpressionHelper:HumanText:text_month' => 'of %s',
	'Class:AttributeCronExpressionHelper:HumanText:text_dom' => 'on the %s',
	'Class:AttributeCronExpressionHelper:HumanText:weekdays:monday' => 'monday',
	'Class:AttributeCronExpressionHelper:HumanText:weekdays:tuesday' => 'tuesday',
	'Class:AttributeCronExpressionHelper:HumanText:weekdays:wednesday' => 'wednesday',
	'Class:AttributeCronExpressionHelper:HumanText:weekdays:thursday' => 'thursday',
	'Class:AttributeCronExpressionHelper:HumanText:weekdays:friday' => 'friday',
	'Class:AttributeCronExpressionHelper:HumanText:weekdays:saturday' => 'saturday',
	'Class:AttributeCronExpressionHelper:HumanText:weekdays:sunday' => 'sunday',
	'Class:AttributeCronExpressionHelper:HumanText:months:january' => 'january',
	'Class:AttributeCronExpressionHelper:HumanText:months:february' => 'february',
	'Class:AttributeCronExpressionHelper:HumanText:months:march' => 'march',
	'Class:AttributeCronExpressionHelper:HumanText:months:april' => 'april',
	'Class:AttributeCronExpressionHelper:HumanText:months:may' => 'may',
	'Class:AttributeCronExpressionHelper:HumanText:months:june' => 'june',
	'Class:AttributeCronExpressionHelper:HumanText:months:july' => 'july',
	'Class:AttributeCronExpressionHelper:HumanText:months:august' => 'august',
	'Class:AttributeCronExpressionHelper:HumanText:months:september' => 'september',
	'Class:AttributeCronExpressionHelper:HumanText:months:october' => 'october',
	'Class:AttributeCronExpressionHelper:HumanText:months:november' => 'november',
	'Class:AttributeCronExpressionHelper:HumanText:months:december' => 'december',
));
